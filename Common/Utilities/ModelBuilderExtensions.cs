...
namespace Common.Utilities
{
    public static class ModelBuilderExtensions
    {
        ...
        /// </summary>
        /// <param name="modelBuilder"></param>
        public static void ConfigureIdentityTables<TKey>(this ModelBuilder modelBuilder, string schema, bool ignoreTables) where TKey : IEquatable<TKey>
        {
            if (ignoreTables)
            {
                modelBuilder.Ignore<IdentityUserLogin<TKey>>();
                modelBuilder.Ignore<IdentityUserClaim<TKey>>();
                modelBuilder.Ignore<IdentityUserToken<TKey>>();
                modelBuilder.Ignore<IdentityRoleClaim<TKey>>();
            }
            else
            {
                modelBuilder.Entity<IdentityUserLogin<TKey>>().ToTable("UserLogin", schema);
                modelBuilder.Entity<IdentityUserClaim<TKey>>().ToTable("UserClaim", schema);
                modelBuilder.Entity<IdentityUserToken<TKey>>().ToTable("UserToken", schema);
                modelBuilder.Entity<IdentityRoleClaim<TKey>>().ToTable("RoleClaim", schema);
                modelBuilder.Entity<IdentityUserRole<TKey>>().ToTable("UserRole", schema);
            }
        }
    }
}
